...
#	This reverts the route of any modified page to the origin url...
#	ie: "teams:detail"
#		<teams> is the context_object_name for the general team url.py
#		<detail> is the url name of the detail view
